...
export default function UserPage({ users = [] }) {
  const [sortOption, setSortOption] = useState("creatorScore");

  // ソート処理
  const sortedUsers = [...users].sort((a, b) => {
    if (sortOption === "creatorScore") {
      // creatorScore順（降順）
      const aScore = a.creatorScore || 0;
      const bScore = b.creatorScore || 0;
  ...
  const sortOptions = [
    { value: "creatorScore", label: "デフォルト" },
    { value: "totalWorks", label: "合計作品数順" },
