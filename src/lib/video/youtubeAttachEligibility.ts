 ...
 * still non-public.  This is deliberately a pure predicate: ownership and
 * privilege have to be resolved by the caller from the authoritative request
 * context, and no form value is used as an ownership signal.
 */
