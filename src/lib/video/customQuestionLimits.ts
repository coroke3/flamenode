...
export const MAX_CUSTOM_QUESTION_KEY_LENGTH = 64;
export const MAX_CUSTOM_QUESTION_OPTIONS = 50;
export const MAX_CUSTOM_QUESTION_OPTION_LENGTH = 200;
...
export const MAX_CUSTOM_QUESTION_CONFIGURED_LENGTH = 5000;
